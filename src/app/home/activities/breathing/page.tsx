...
export default function BreathingExercisePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold font-headline">Breathing Exercise</h1>
        <p className="text-muted-foreground">
            Center yourself with a guided box breathing session.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center pt-4">
        ...
        <div className="mt-8 text-center">
          <h2 className="text-xl font-bold sm:text-2xl font-headline">Box Breathing</h2>
